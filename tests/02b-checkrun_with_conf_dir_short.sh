...
# Check --limit option
check_message_in_output "ansible-deployer run -t task_with_limit -s testing -i testInfra2 -l xyzHost4 --conf-dir=/etc/alternate-deployer-dir" "ERROR\! Specified inventory, host pattern and/or --limit leaves us with no hosts to target."
