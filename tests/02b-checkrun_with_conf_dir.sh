...
# Check --limit option
check_message_in_output "ansible-deployer run --task task_with_limit --stage testing --infrastructure testInfra2 --limit xyzHost4 --conf-dir=/etc/alternate-deployer-dir" "ERROR\! Specified inventory, host pattern and/or --limit leaves us with no hosts to target."
