...
check_run_ok 'ansible-deployer verify --task=task_exec_bin_true -s prod -i testInfra --conf-dir=/etc/alternate-deployer-dir'
...
check_message_in_output 'ansible-deployer verify --task=task_exec_bin_true -s prod -i testInfra --conf-dir=/etc/alternate-deployer-dir' '1 passed'
