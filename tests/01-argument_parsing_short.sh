...
check_message_in_output 'ansible-deployer list -c task_exec_bin_true'  '\[ERROR\]: commit is not supported by list'
...
check_run_ok "ansible-deployer list -t task_exec_bin_true"
